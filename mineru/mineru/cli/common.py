...
from mineru.backend.vlm.vlm_analyze import \
    aio_doc_analyze as aio_vlm_doc_analyze
...
def do_parse(
    ...
    table_enable=True,
    server_url=None,
    f_draw_layout_bbox=False,  # 默认关闭绘制 layout bbox
    f_draw_span_bbox=False,  # 默认关闭绘制 span bbox
    f_dump_md=True,
...
if __name__ == "__main__":
    ...
    pdf_path = (
        "C:/Users/zhaoxiaomeng/Downloads/4546d0e2-ba60-40a5-a17e-b68555cec741.pdf"
    )
