...
def check_platform():
    ...
    if system != "Darwin":
        print(
            "WARNING: This script is optimized for macOS, but may work on other platforms"
        )
...
def check_dependencies():
    ...
    required_packages = ["sentence_transformers", "faiss", "numpy", "PyPDF2"]

    optional_packages = ["llama_cpp", "textract"]
...
def check_files():
    ...
    required_files = ["run_rag.py", "parse_with_mineru.py", "embed.py", "query.py"]
